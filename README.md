...
| Titres de recettes + PDF (ordonnancement) + bordereau récapitulatif PDF/Excel horodaté avec hash SHA-256 + rôle TLPE PDF/Excel archivé + état de recouvrement (page + PDF/Excel archivés) + mises en demeure PDF unitaire/batch archivées | §7.1 / §10.2 / US5.1 / US8.1 / US8.2 / US5.8 | OK + tests |
...
- Rapports PDF avancés autres que le titre de recettes, le bordereau récapitulatif des titres (§10.2), **à l’exception du rapport de contrôle automatique US7.3, du rôle TLPE US8.1 et de l’état de recouvrement US8.2 désormais implémentés**
